...
declare class Move {
    /**
     * Function to initialize current directory for Endless
     *
     * Configuration will be pushed into .endless/config.yaml
    ...
    /**
     * Function to publishe the modules in a Move package to the Endless blockchain
     *
     * @param args.packageDirectoryPath Path to a move package (the folder with a Move.toml file)
     * @param args.namedAddresses  Named addresses for the move binary
     * @example
