...
type GetNamesQueryVariables = Exact<{
    offset?: InputMaybe<Scalars["Int"]["input"]>;
    limit?: InputMaybe<Scalars["Int"]["input"]>;
    where_condition?: InputMaybe<CurrentEndlessNamesBoolExp>;
    order_by?: InputMaybe<Array<CurrentEndlessNamesOrderBy> | CurrentEndlessNamesOrderBy>;
}>;
type GetNamesQuery = {
...
export type { AnsTokenFragmentFragment, CurrentTokenOwnershipFieldsFragment, GetAccountCoinData, GetAccountCoinsCountQuery, GetAccountCoinsCountQueryVariables, GetAccountCoinsDataQuery, GetAccountCoinsDataQueryVariables, GetAccountCollectionsWithOwnedTokensQuery, GetAccountCollectionsWithOwnedTokensQueryVariables, GetAccountOwnedObjectsQuery, GetAccountOwnedObjectsQueryVariables, GetAccountOwnedTokensByTokenDataQuery, GetAccountOwnedTokensByTokenDataQueryVariables, GetAccountOwnedTokensFromCollectionQuery, GetAccountOwnedTokensFromCollectionQueryVariables, GetAccountOwnedTokensQuery, GetAccountOwnedTokensQueryVariables, GetAccountTokensCountQuery, GetAccountTokensCountQueryVariables, GetAccountTransactionsCountQuery, GetAccountTransactionsCountQueryVariables, GetAccountsCoinBalanceData, GetChainTopUserTransactionsQuery, GetChainTopUserTransactionsQueryVariables, GetCoinData, GetCollectionDataQuery, GetCollectionDataQueryVariables, GetCreatedCoinDataQuery, GetCurrentFungibleAssetBalancesQuery, GetCurrentFungibleAssetBalancesQueryVariables, GetCurrentTokenOwnershipQuery, GetCurrentTokenOwnershipQueryVariables, GetDelegatedStakingActivitiesQuery, GetDelegatedStakingActivitiesQueryVariables, GetEventsQuery, GetEventsQueryVariables, GetFungibleAssetActivitiesQuery, GetFungibleAssetActivitiesQueryVariables, GetFungibleAssetMetadataQuery, GetFungibleAssetMetadataQueryVariables, GetNamesQuery, GetNamesQueryVariables, GetNumberOfDelegatorsQuery, GetNumberOfDelegatorsQueryVariables, GetProcessorStatusQuery, GetProcessorStatusQueryVariables, GetTableItemsDataQuery, GetTableItemsDataQueryVariables, GetTableItemsMetadataQuery, GetTableItemsMetadataQueryVariables, GetTokenActivityQuery, GetTokenActivityQueryVariables, GetTokenDataQuery, GetTokenDataQueryVariables, TokenActivitiesFieldsFragment };
