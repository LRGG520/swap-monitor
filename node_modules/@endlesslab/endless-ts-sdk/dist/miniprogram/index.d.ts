...
declare const NetworkToIndexerAPIV2: Record<string, string>;
...
type CurrentEndlessNamesAggregateBoolExp = {
    bool_and?: InputMaybe<CurrentEndlessNamesAggregateBoolExpBoolAnd>;
    bool_or?: InputMaybe<CurrentEndlessNamesAggregateBoolExpBoolOr>;
    count?: InputMaybe<CurrentEndlessNamesAggregateBoolExpCount>;
};
type CurrentEndlessNamesAggregateBoolExpBoolAnd = {
    arguments: CurrentEndlessNamesSelectColumnCurrentEndlessNamesAggregateBoolExpBoolAndArgumentsColumns;
    distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
    filter?: InputMaybe<CurrentEndlessNamesBoolExp>;
    predicate: BooleanComparisonExp;
};
type CurrentEndlessNamesAggregateBoolExpBoolOr = {
    arguments: CurrentEndlessNamesSelectColumnCurrentEndlessNamesAggregateBoolExpBoolOrArgumentsColumns;
    distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
    filter?: InputMaybe<CurrentEndlessNamesBoolExp>;
    predicate: BooleanComparisonExp;
};
type CurrentEndlessNamesAggregateBoolExpCount = {
    arguments?: InputMaybe<Array<CurrentEndlessNamesSelectColumn>>;
    distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
    filter?: InputMaybe<CurrentEndlessNamesBoolExp>;
    predicate: IntComparisonExp;
};
/** Boolean expression to filter rows from the table "current_endless_names". All fields are combined with a logical 'AND'. */
type CurrentEndlessNamesBoolExp = {
    _and?: InputMaybe<Array<CurrentEndlessNamesBoolExp>>;
    _not?: InputMaybe<CurrentEndlessNamesBoolExp>;
    _or?: InputMaybe<Array<CurrentEndlessNamesBoolExp>>;
    ...
    is_domain_owner?: InputMaybe<CurrentEndlessNamesBoolExp>;
...
/** select columns of table "current_endless_names" */
declare enum CurrentEndlessNamesSelectColumn {
    /** column name */
    Domain = "domain",
    /** column name */
...
/** select "current_endless_names_aggregate_bool_exp_bool_and_arguments_columns" columns of table "current_endless_names" */
declare enum CurrentEndlessNamesSelectColumnCurrentEndlessNamesAggregateBoolExpBoolAndArgumentsColumns {
    /** column name */
    IsActive = "is_active",
    /** column name */
    IsPrimary = "is_primary"
}
/** select "current_endless_names_aggregate_bool_exp_bool_or_arguments_columns" columns of table "current_endless_names" */
declare enum CurrentEndlessNamesSelectColumnCurrentEndlessNamesAggregateBoolExpBoolOrArgumentsColumns {
    /** column name */
    IsActive = "is_active",
    /** column name */
    IsPrimary = "is_primary"
...
type FungibleAssetActivitiesBoolExp = {
    ...
    metadata?: InputMaybe<FungibleAssetMetadataBoolExp>;
    owner_address?: InputMaybe<StringComparisonExp>;
    owner_endless_names?: InputMaybe<CurrentEndlessNamesBoolExp>;
    owner_endless_names_aggregate?: InputMaybe<CurrentEndlessNamesAggregateBoolExp>;
    storage_id?: InputMaybe<StringComparisonExp>;
...
type GetAccountCoinsDataQuery = {
    data: Array<GetAccountCoinData>;
    page: number;
    pageSize: number;
    total: number;
};
type GetCreatedCoinDataQuery = {
    data: Array<GetCoinData>;
    page: number;
    pageSize: number;
    total: number;
};
...
type GetAccountsCoinBalanceData = {
    address: string;
    balance: string;
    frozen: boolean;
};
...
type GetAccountCoinsDataResponse = GetAccountCoinsDataQuery;
type GetCoinDataResponse = GetAccountCoinData["metadata"];
type GetCreatedCoinDataResponse = GetCreatedCoinDataQuery;
...
type GetANSNameResponse = GetNamesQuery["current_endless_names"];
type GetAccountsCoinBalanceResponse = GetAccountsCoinBalanceData[];
/**
...
interface PaginationArgsOfIndexer {
    pageSize?: number;
    page?: number;
}
...
/**
 * This class is the Endless Typescript SDK representation of a Move `vector<T>`,
...
declare class AccountAddress extends Serializable implements TransactionArgument {
    ...
    toString(): `0x${string}`;
    /**
     * Converts the current object's data into a Base58 string.
     * This function takes no parameters.
     *
     * @returns {string} Returns the converted Base58 string.
     */
    toBs58String(): string;
    /**
    ...
    static fromBs58String(input: string): AccountAddress;
    /**
...
declare class Ed25519Signature extends Signature {
     ...
     *
     * Comes from Endless Core
     * https://github.com/endless-labs/endless-core/blob/main/crates/endless-crypto/src/ed25519/ed25519_sigs.rs#L47-L85
     */
...
/**
 * Endless derive path is 637
 */
declare const ENDLESS_HARDENED_REGEX: RegExp;
declare const ENDLESS_BIP44_REGEX: RegExp;
/**
...
declare class MultiEd25519PublicKey extends AccountPublicKey {
     ...
     *
     * @see {@link
     * https://endless.dev/integration/creating-a-signed-transaction/ | Creating a Signed Transaction}
     *
...
declare class MultiEd25519Signature extends Signature {
     ...
     *
     * @see {@link
     * https://endless.dev/integration/creating-a-signed-transaction/#multisignature-transactions | Creating a Signed Transaction}
     *
 ...
 *
 * The public keys of each individual agent can be any type of public key supported by Endless.
 * Since [AIP-55](https://github.com/endless-foundation/AIPs/pull/263) Endless supports
 * `Legacy` and `Unified` authentication keys.
 */
...
/**
 * Represents ephemeral public keys for Endless Keyless accounts.
 *
...
/**
 * Represents ephemeral signatures used in Endless Keyless accounts.
 *
 ...
 */
declare const ENDLESS_COIN = "0x1::endless_coin::EndlessCoin";
declare const ENDLESS_COIN_ID = "ENDLESSsssssssssssssssssssssssssssssssssssss";
declare const RAW_TRANSACTION_SALT = "ENDLESS::RawTransaction";
declare const RAW_TRANSACTION_WITH_DATA_SALT = "ENDLESS::RawTransactionWithData";
/**
 ...
 *
 */
declare class MultiAuthKeyPublicKey extends AccountPublicKey {
    /**
     * List of any public keys
     */
    readonly publicKeys: AnyPublicKey[];
...
declare class MultiAuthKeySignature extends Signature {
    /**
 ...
 * @see {@link https://endless.dev/concepts/accounts | Account Basics}
 *
...
declare class AccountAuthenticatorMultiAuthKey extends AccountAuthenticator {
    readonly public_key: MultiAuthKeyPublicKey;
    readonly signature: MultiAuthKeySignature;
...
declare class AccountAuthenticatorBls12381 extends AccountAuthenticator {
    readonly public_key: Bls12381PublicKey;
    readonly signature: Bls12381Signature;
...
declare class AccountAuthenticatorMock extends AccountAuthenticator {
    readonly authenticator: AccountAddress;
...
declare function endlessCoinStructTag(): StructTag;
...
declare class TransactionPayloadScript extends TransactionPayload {
    ...
    paymentChecksum?: Uint8Array;
    constructor(script: Script);
    serialize(serializer: Serializer): void;
    static load(deserializer: Deserializer): TransactionPayloadScript;
    static loadWithChecksum(deserializer: Deserializer): TransactionPayloadScript;
}
/**
...
declare class TransactionPayloadEntryFunction extends TransactionPayload {
    ...
    static loadWithChecksum(deserializer: Deserializer): TransactionPayloadEntryFunction;
}
/**
...
declare class Script {
    ...
    /**
     * Scripts contain the Move bytecodes payload that can be submitted to Endless chain for execution.
     *
...
declare class RawTransaction extends Serializable {
    ...
    /**
     * RawTransactions contain the metadata and payloads that can be submitted to Endless chain for execution.
     * RawTransactions must be signed before Endless chain can execute them.
     *
     * @param sender The sender Account Address
     * @param sequence_number Sequence number of this transaction. This must match the sequence number stored in
     *   the sender's account at the time the transaction executes.
     * @param payload Instructions for the Endless Blockchain, including publishing a module,
...
declare class SimpleTransaction extends Serializable {
    ...
    upgradeToSafe(checksum: Uint8Array): void;
}
...
type InputSimulateTransactionDataMock = {
    /**
     * The transaction to simulate, probably generated by `generateTransaction()`
     */
    transaction: AnyRawTransaction;
...
/**
 * Interface for a generic Endless account.
 *
...
declare abstract class Account$1 {
     ...
     * See here for more info: {@link https://endless.dev/concepts/accounts#single-signer-authentication}
     *
 ...
 * https://endless.dev/guides/keyless-accounts/#1-present-the-user-with-a-sign-in-with-idp-button-on-the-ui
 */
 ...
 * Note: Generating a signer instance does not create the account on-chain.
 */
declare class MultiAuthKeyAccount implements Account$1 {
    ...
    static isMultiKeySigner(account: Account$1): account is MultiAuthKeyAccount;
    /**
     * Sign a message using the account's signers.
     * @param message the signing message, as binary input
     * @return the AccountAuthenticator containing the signature, together with the account's public key
...
declare class Coin {
     ...
     */
    getCoinData(coinAddress: AccountAddressInput): Promise<GetCoinDataResponse>;
    /**
     * @param args.coinListAddress The coin list address
     *
     * @returns GetCoinDataResponse[]
     */
    getCoinListDataById(coinListAddress: AccountAddressInput[]): Promise<GetCoinDataResponse[]>;
}
...
/**
 * A class to query all `DigitalAsset` related queries on Endless.
 */
declare class DigitalAsset {
     ...
     *
     * @example
     * const collection = await endless.getCollectionData({creatorAddress:"0x123",collectionName:"myCollection"})
     *
     ...
     *
     * @example
     * const collection = await endless.getCollectionDataByCollectionId({collectionId:"0x123"})
     *
     ...
     *
     * @example
     * const collection = await endless.getCollectionId({creatorAddress:"0x123",collectionName:"myCollection"})
     *
     * @param args.creatorAddress the address of the collection's creator
     * @param args.collectionName the name of the collection
     * @param args.minimumLedgerVersion Optional ledger version to sync up to, before querying
     ...
     *
     * @example
     * const digitalAsset = await endless.getDigitalAssetData({digitalAssetAddress:"0x123"})
     *
     ...
     *
     * @example
     * const digitalAssetOwner = await endless.getCurrentDigitalAssetOwnership({digitalAssetAddress:"0x123"})
     *
     * @param args.tokenAddress The address of the digital asset
     * @param args.minimumLedgerVersion Optional ledger version to sync up to, before querying
     *
     ...
     *
     * @example
     * const digitalAssets = await endless.getOwnedDigitalAssets({ownerAddress:"0x123"})
     *
     ...
     *
     * @example
     * const digitalAssetActivity = await endless.getDigitalAssetActivity({digitalAssetAddress:"0x123"})
     *
     * @param args.tokenAddress The address of the digital asset
     * @param args.minimumLedgerVersion Optional ledger version to sync up to, before querying
     *
     ...
     *
     * @example
     * const transaction = await endless.createCollectionTransaction({
     *  creator: alice,
     ...
     *
     * @example
     * const transaction = await endless.mintDigitalAssetTransaction({
     *  creator: alice,
     *  description: "collectionDescription",
     ...
     *
     * @example
     * const transaction = await endless.transferDigitalAssetTransaction({
     *  sender: alice,
     ...
     *
     * @example
     * const transaction = await endless.mintSoulBoundTransaction({
     *  account: alice,
     *  collection: "collectionName",
     *  description: "collectionDescription",
     *  name: "digitalAssetName",
     ...
     *
     * @example
     * const transaction = await endless.burnDigitalAssetTransaction({
     *  creator: alice,
     *  digitalAssetAddress: "0x123",
     * });
     *
     ...
     *
     * @example
     * const transaction = await endless.freezeDigitalAssetTransaferTransaction({
     *  creator: alice,
     *  digitalAssetAddress: "0x123",
     * });
     *
     ...
     *
     * @example
     * const transaction = await endless.unfreezeDigitalAssetTransaferTransaction({
     *  creator: alice,
     *  digitalAssetAddress: "0x123",
     * });
     *
     ...
     *
     * @example
     * const transaction = await endless.setDigitalAssetDescriptionTransaction({
     *  creator: alice,
     ...
     *
     * @example
     * const transaction = await endless.setDigitalAssetNameTransaction({
     *  creator: alice,
     *  name: "digitalAssetName",
     *  digitalAssetAddress: "0x123",
     * });
     ...
     *
     * @example
     * const transaction = await endless.setDigitalAssetURITransaction({
     *  creator: alice,
     *  uri: "digital-asset-uri.com",
     *  digitalAssetAddress: "0x123",
     * });
     ...
     *
     * @example
     * const transaction = await endless.addDigitalAssetPropertyTransaction({
     *  creator: alice,
     *  propertyKey: "newKey",
     ...
     *
     * @example
     * const transaction = await endless.removeDigitalAssetPropertyTransaction({
     *  creator: alice,
     *  propertyKey: "newKey",
     *  propertyType: "BOOLEAN",
     *  propertyValue: true,
     ...
     *
     * @example
     * const transaction = await endless.updateDigitalAssetPropertyTransaction({
     *  creator: alice,
     *  propertyKey: "newKey",
     *  propertyType: "BOOLEAN",
     *  propertyValue: false,
     ...
     *
     * @example
     * const transaction = await endless.addDigitalAssetTypedPropertyTransaction({
     *  creator: alice,
     ...
     *
     * @example
     * const transaction = await endless.updateDigitalAssetTypedPropertyTransaction({
     *  creator: alice,
     *  propertyKey: "typedKey",
     *  propertyType: "U8",
     *  propertyValue: 2,
 ...
 * @returns A signed serialized transaction that can be simulated
 */
declare function generateMockSignedTransactionForSimulation(transaction: AnyRawTransaction): Uint8Array;
 ...
 * @param endlessConfig
 */
declare function fetchFunctionAbi(moduleAddress: string, moduleName: string, functionName: string, endlessConfig: EndlessConfig): Promise<MoveFunction | undefined>;
/**
 ...
 * @param endlessConfig
 */
declare function fetchEntryFunctionAbi(moduleAddress: string, moduleName: string, functionName: string, endlessConfig: EndlessConfig): Promise<EntryFunctionABI>;
/**
 ...
 * @param endlessConfig
 */
declare function fetchViewFunctionAbi(moduleAddress: string, moduleName: string, functionName: string, endlessConfig: EndlessConfig): Promise<ViewFunctionABI>;
/**
 ...
 *
 * @param transaction A endless transaction type
 *
 ...
 * @param domainSeparator A domain separator that starts with 'ENDLESS::'
 *
...
declare class ANS {
     ...
     *
     * @example
     * // Will return the owner address of "test.endless.apt" or undefined
     * const owner = await endless.getOwnerAddress({name: "test.endless"})
     * // owner = 0x123...
     *
     ...
     *
     * @example
     * // Will return the expiration of "test.endless.apt" or undefined
     * const exp = await endless.getExpiration({name: "test.endless"})
     ...
     *
     * @example
     * const targetAddr = await endless.getTargetAddress({name: "test.endless"})
     * // targetAddr = 0x123...
     *
     ...
     *
     * @example
     * await endless.setTargetAddress({sender: alice, name: "test.endless", address: bob.accountAddress})
     * const address = await endless.getTargetAddress({name: "test.endless"})
     * // address = bob.accountAddress
     *
     * @param args.name - A string of the name: test.endless.apt, test.apt, test, test.endless, etc.
     ...
     *
     * @example
     * const name = await endless.getPrimaryName({address: alice.accountAddress})
     * // name = test.endless
     *
     ...
     *
     * @example
     * await endless.setPrimaryName({sender: alice, name: "test.endless"})
     * const primaryName = await endless.getPrimaryName({address: alice.accountAddress})
     * // primaryName = test.endless
     *
     * @param args.sender - The sender account
     * @param args.name - A string of the name: test, test.apt, test.endless, test.endless.apt, etc.
     *
     * @returns SimpleTransaction
     */
    setPrimaryName(args: {
     ...
     *  const txn = endless.registerName({
     *    sender: alice,
     *    name: "test.endless.apt",
     *    expiration: {
     *      policy: "subdomain:independent",
     ...
     * Examples include: "test", "test.apt", "test.endless.apt", etc.
     ...
     * @returns SimpleTransaction
     */
    registerName(args: Omit<RegisterNameParameters, "endlessConfig">): Promise<SimpleTransaction>;
    /**
     ...
     *
     * @example
     * await endless.renewDomain({sender: alice, name: "test"})
     ...
     * @param args.name - A string of the name to retrieve, e.g. "test.endless.apt"
...
declare class AccountSequenceNumber {
    readonly endlessConfig: EndlessConfig;
    ...
    sleepTime: number;
    constructor(endlessConfig: EndlessConfig, account: Account$1, maxWaitTime: number, maximumInFlight: number, sleepTime: number);
    /**
...
declare class TransactionWorker extends EventEmitter<TransactionWorkerEvents> {
     ...
     *
     * @param endlessConfig - a config object
     ...
     * @param account an Endless account
...
declare class EndlessAccount {
    ...
    viewCoinBalance(account: AccountAddress, fungibleAssetMetadataAddress: AccountAddress): Promise<bigint>;
    viewEDSBalance(account: AccountAddress): Promise<bigint>;
}
...
interface Endless extends Account, ANS, Coin, DigitalAsset, EndlessAccount, Event, FungibleAsset, General, Staking, Table, Omit<Transaction, "build" | "simulate" | "submit" | "batch"> {
}
...
declare function getPaymentChecksum(simulateResult: UserTransactionResponse): Uint8Array;
 ...
 */
interface EndlessResponse<Req, Res> {
    status: number;
    statusText: string;
    data: Res;
    url: string;
 ...
 */
declare class EndlessApiError extends Error {
    readonly url: string;
 ...
 */
declare function endlessRequest<Req extends {}, Res extends {}>(options: EndlessRequest, endlessConfig: EndlessConfig, apiType: EndlessApiType): Promise<EndlessResponse<Req, Res>>;
...
type GetEndlessRequestOptions = Omit<GetRequestOptions, "type">;
/**
 ...
 * @returns
 */
declare function get<Req extends {}, Res extends {}>(options: GetRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function getEndlessFullNode<Req extends {}, Res extends {}>(options: GetEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function getEndlessIndexer<Req extends {}, Res extends {}>(options: GetEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function paginateWithCursor<Req extends Record<string, any>, Res extends Array<{}>>(options: GetEndlessRequestOptions): Promise<Res>;
...
type PostEndlessRequestOptions = Omit<PostRequestOptions, "type">;
/**
 ...
 * @returns
 */
declare function post<Req extends {}, Res extends {}>(options: PostRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function postEndlessFullNode<Req extends {}, Res extends {}>(options: PostEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function postEndlessIndexer<Req extends {}, Res extends {}>(options: PostEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function postEndlessFaucet<Req extends {}, Res extends {}>(options: PostEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
/**
 ...
 */
declare function postEndlessPepperService<Req extends {}, Res extends {}>(options: PostEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
declare function postEndlessProvingService<Req extends {}, Res extends {}>(options: PostEndlessRequestOptions): Promise<EndlessResponse<Req, Res>>;
...
export { Account$1 as Account, AccountAddress, type AccountAddressInput, AccountAuthenticator, AccountAuthenticatorBls12381, AccountAuthenticatorEd25519, AccountAuthenticatorMock, AccountAuthenticatorMultiAuthKey, AccountAuthenticatorMultiEd25519, AccountAuthenticatorMultiKey, AccountAuthenticatorSingleKey, AccountAuthenticatorVariant, type AccountData, AccountPublicKey, AccountSequenceNumber, type AccountSignature, AddressInvalidReason, type AnyNumber, AnyPublicKey, AnyPublicKeyVariant, type AnyRawTransaction, type AnyRawTransactionInstance, AnySignature, AnySignatureVariant, type AnyTransactionPayloadInstance, AuthenticationKey, type AuthenticationKeyScheme, type Block, type BlockEndInfo, type BlockEpilogueTransactionResponse, type BlockMetadataTransactionResponse, Bls12381PrivateKey, Bls12381PublicKey, Bls12381Signature, Bool, CKDPriv, ChainId, type Client, type ClientConfig, type ClientHeadersType, type ClientRequest, type ClientResponse, type CommittedTransactionResponse, type CreateAccountFromPrivateKeyArgs, type CreateEd25519AccountFromPrivateKeyArgs, type CreateEd25519SingleKeyAccountFromPrivateKeyArgs, type CreateSingleKeyAccountFromPrivateKeyArgs, DEFAULT_MAX_GAS_AMOUNT, DEFAULT_TXN_EXP_SEC_FROM_NOW, DEFAULT_TXN_TIMEOUT_SEC, type DecodedTableData, type DeletedTableData, DeriveScheme, type DerivedKeys, type Deserializable, type DeserializableClass, Deserializer, type DirectWriteSet, ENDLESS_BIP44_REGEX, ENDLESS_COIN, ENDLESS_COIN_ID, ENDLESS_HARDENED_REGEX, EPK_HORIZON_SECS, Ed25519Account, Ed25519PrivateKey, Ed25519PublicKey, Ed25519Signature, type Ed25519SignerConstructorArgs, type Ed25519SignerFromDerivationPathArgs, Endless, EndlessApiError, EndlessApiType, EndlessConfig, type EndlessRequest, type EndlessResponse, type EndlessSettings, EntryFunction, type EntryFunctionABI, type EntryFunctionArgument, type EntryFunctionArgumentTypes, EntryFunctionBytes, type EntryFunctionPayloadResponse, EphemeralCertificate, EphemeralCertificateVariant, EphemeralKeyPair, EphemeralPublicKey, EphemeralPublicKeyVariant, EphemeralSignature, EphemeralSignatureVariant, type Event$1 as Event, type EventGuid, type ExecutionFinishEventData, type FailureEventData, FeePayerRawTransaction, FixedBytes, type FullNodeConfig, type FunctionABI, type GasEstimation, type GenerateAccount, type GenerateAccountArgs, type GenerateAccountWithEd25519, type GenerateAccountWithSingleSignerSecp256k1Key, type GenerateEd25519AccountArgs, type GenerateEd25519SingleKeyAccountArgs, type GenerateSingleKeyAccountArgs, type GenesisPayload, type GenesisTransactionResponse, type GetANSNameResponse, type GetAccountCoinsDataResponse, type GetAccountCollectionsWithOwnedTokenResponse, type GetAccountOwnedObjectsResponse, type GetAccountOwnedTokensFromCollectionResponse, type GetAccountOwnedTokensQueryResponse, type GetAccountsCoinBalanceResponse, type GetChainTopUserTransactionsResponse, type GetCoinDataResponse, type GetCollectionDataResponse, type GetCreatedCoinDataResponse, type GetCurrentFungibleAssetBalancesResponse, type GetCurrentTokenOwnershipResponse, type GetDelegatedStakingActivitiesResponse, type GetEndlessRequestOptions, type GetEventsResponse, type GetFungibleAssetActivitiesResponse, type GetFungibleAssetMetadataResponse, type GetNumberOfDelegatorsResponse, type GetOwnedTokensResponse, type GetProcessorStatusResponse, type GetRequestOptions, type GetTableItemsDataResponse, type GetTableItemsMetadataResponse, type GetTokenActivityResponse, type GetTokenDataResponse, type GraphqlQuery, Groth16Zkp, HARDENED_OFFSET, Hex, type HexInput, HexInvalidReason, Identifier, type IndexerConfig, type InputEntryFunctionData, type InputEntryFunctionDataWithABI, type InputEntryFunctionDataWithRemoteABI, type InputGenerateMultiAgentRawTransactionArgs, type InputGenerateMultiAgentRawTransactionData, type InputGenerateRawTransactionArgs, type InputGenerateSingleSignerRawTransactionArgs, type InputGenerateSingleSignerRawTransactionData, type InputGenerateTransactionData, type InputGenerateTransactionOptions, type InputGenerateTransactionPayloadData, type InputGenerateTransactionPayloadDataWithABI, type InputGenerateTransactionPayloadDataWithRemoteABI, type InputMultiSigData, type InputMultiSigDataWithABI, type InputMultiSigDataWithRemoteABI, type InputScriptData, type InputSimulateTransactionData, type InputSimulateTransactionDataMock, type InputSimulateTransactionOptions, type InputSubmitTransactionData, type InputViewFunctionData, type InputViewFunctionDataWithABI, type InputViewFunctionDataWithRemoteABI, KeyType, KeylessAccount, KeylessConfiguration, KeylessPublicKey, KeylessSignature, type LedgerInfo, type LedgerVersionArg, MAX_AUD_VAL_BYTES, MAX_COMMITED_EPK_BYTES, MAX_EXTRA_FIELD_BYTES, MAX_ISS_VAL_BYTES, MAX_JWT_HEADER_B64_BYTES, MAX_UID_KEY_BYTES, MAX_UID_VAL_BYTES, MimeType, ModuleId, MoveAbility, type MoveAddressType, type MoveFunction, type MoveFunctionGenericTypeParam, type MoveFunctionId, MoveFunctionVisibility, type MoveModule, type MoveModuleBytecode, type MoveModuleId, type MoveObjectType, MoveOption, type MoveOptionType, type MoveResource, type MoveScriptBytecode, MoveString, type MoveStruct, type MoveStructField, type MoveStructId, type MoveStructType, type MoveType, type MoveUint128Type, type MoveUint16Type, type MoveUint256Type, type MoveUint32Type, type MoveUint64Type, type MoveUint8Type, type MoveValue, MoveVector, MultiAgentRawTransaction, MultiAgentTransaction, MultiAuthKeyAccount, MultiAuthKeyPublicKey, MultiAuthKeySignature, MultiEd25519PublicKey, MultiEd25519Signature, MultiKey, MultiKeyAccount, MultiKeySignature, MultiSig, MultiSigTransactionPayload, type MultisigPayloadResponse, Network, NetworkToChainId, NetworkToFaucetAPI, NetworkToIndexerAPI, NetworkToIndexerAPIV2, NetworkToNetworkName, NetworkToNodeAPI, NetworkToProverAPI, type OrderBy, type OrderByArg, type OrderByValue, type PaginationArgs, type PaginationArgsOfIndexer, ParsingError, type ParsingResult, type PendingTransactionResponse, type PostEndlessRequestOptions, type PostRequestOptions, type PrivateKey, type PrivateKeyFromDerivationPathArgs, ProcessorType, type ProofFetchCallback, type ProofFetchEvents, type ProofFetchFailure, type ProofFetchStatus, type ProofFetchSuccess, PublicKey, RAW_TRANSACTION_SALT, RAW_TRANSACTION_WITH_DATA_SALT, RawTransaction, RawTransactionWithData, RoleType, RotationProofChallenge, Script, type ScriptFunctionArgument, type ScriptFunctionArgumentTypes, type ScriptPayloadResponse, ScriptTransactionArgumentVariants, type ScriptWriteSet, Secp256k1PrivateKey, Secp256k1PublicKey, Secp256k1Signature, Serializable, Serializer, Signature, SignedTransaction, SigningScheme, SigningSchemeInput, type SimpleEntryFunctionArgumentTypes, SimpleTransaction, SingleKeyAccount, type SingleKeySignerConstructorArgs, type SingleKeySignerFromDerivationPathArgs, type SingleKeySignerGenerateArgs, type StateCheckpointTransactionResponse, StructTag, type SuccessEventData, type TableItemRequest, type TokenStandard, type TokenStandardArg, type TransactionArgument, TransactionAuthenticator, TransactionAuthenticatorEd25519, TransactionAuthenticatorFeePayer, TransactionAuthenticatorMultiAgent, TransactionAuthenticatorMultiEd25519, TransactionAuthenticatorSingleSender, TransactionAuthenticatorVariant, type TransactionEd25519Signature, type TransactionFeePayerSignature, type TransactionMultiAgentSignature, type TransactionMultiEd25519Signature, TransactionPayload, TransactionPayloadEntryFunction, TransactionPayloadMultiSig, type TransactionPayloadResponse, TransactionPayloadScript, TransactionPayloadVariants, type TransactionResponse, TransactionResponseType, type TransactionSecp256k1Signature, type TransactionSignature, TransactionVariants, TransactionWorker, type TransactionWorkerEvents, TransactionWorkerEventsEnum, type TypeArgument, TypeTag, TypeTagAddress, TypeTagBool, TypeTagGeneric, TypeTagParserError, TypeTagParserErrorType, TypeTagReference, TypeTagSigner, TypeTagStruct, TypeTagU128, TypeTagU16, TypeTagU256, TypeTagU32, TypeTagU64, TypeTagU8, TypeTagVariants, TypeTagVector, U128, U16, U256, U32, U64, U8, type Uint128, type Uint16, type Uint256, type Uint32, type Uint64, type Uint8, type UserTransactionResponse, type ValidatorTransactionResponse, type VerifyEd25519SignatureArgs, type VerifyMultiAuthKeySignatureArgs, type VerifyMultiKeySignatureArgs, type VerifySignatureArgs, type VerifySingleKeySignatureArgs, type ViewFunctionABI, type WaitForTransactionOptions, type WhereArg, type WriteSet, type WriteSetChange, type WriteSetChangeDeleteModule, type WriteSetChangeDeleteResource, type WriteSetChangeDeleteTableItem, type WriteSetChangeWriteModule, type WriteSetChangeWriteResource, type WriteSetChangeWriteTableItem, ZeroKnowledgeSig, buildTransaction, checkOrConvertArgument, convertArgument, deriveKey, deriveKeylessAccount, deriveTransactionType, deserializeFromScriptArgument, endlessCoinStructTag, endlessRequest, ensureBoolean, fetchEntryFunctionAbi, fetchFunctionAbi, fetchViewFunctionAbi, findFirstNonSignerArg, generateMockSignedTransactionForSimulation, generateRawTransaction, generateSignedTransaction, generateSignedTransactionForSimulation, generateSigningMessage, generateSigningMessageForSerializable, generateSigningMessageForTransaction, generateTransactionPayload, generateTransactionPayloadWithABI, generateUserTransactionHash, generateViewFunctionPayload, generateViewFunctionPayloadWithABI, get, getAuthenticatorForSimulation, getEndlessFullNode, getEndlessIndexer, getFunctionParts, getKeylessConfig, getPaymentChecksum, hashValues, isBcsAddress, isBcsBool, isBcsFixedBytes, isBcsString, isBcsU128, isBcsU16, isBcsU256, isBcsU32, isBcsU64, isBcsU8, isBlockEpilogueTransactionResponse, isBlockMetadataTransactionResponse, isBool, isEd25519Signature, isEncodedEntryFunctionArgument, isFeePayerSignature, isGenesisTransactionResponse, isLargeNumber, isMultiAgentSignature, isMultiEd25519Signature, isNull, isNumber, isPendingTransactionResponse, isScriptDataInput, isSecp256k1Signature, isStateCheckpointTransactionResponse, isString, isUserTransactionResponse, isValidBIP44Path, isValidHardenedPath, isValidatorTransactionResponse, mnemonicToSeed, normalizeBundle, objectStructTag, optionStructTag, outOfRangeErrorMessage, paginateWithCursor, parseTypeTag, post, postEndlessFaucet, postEndlessFullNode, postEndlessIndexer, postEndlessPepperService, postEndlessProvingService, promiseFulfilledStatus, request, splitPath, standardizeTypeTags, stringStructTag, throwTypeMismatch, validateNumberInRange };
